...
class User:
    ...
    @classmethod
    def create_from_string(cls, string_param):
...
string_param = "Sonic-sonic@nintendo.com-Admin"
sonic = User.create_from_string(string_param)
print(sonic.info())


# pemanggilan static method menggunakan decorator @staticmethod
zelda_tweet = User.tweet("Hello, saya sedang belajar Python")
print(zelda_tweet)
